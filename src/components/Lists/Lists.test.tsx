...
describe('Lists tests', () => {
  it('Properly renders Lists when passed valid credentials and list info', () => {
    ...
    expect(
      getByRole('tab', { name: /lodging/i, selected: true })
    ).toBeInTheDocument();
    expect(getByRole('tab', { name: /restaurants/i })).toBeInTheDocument();
    expect(getByRole('tab', { name: /transportation/i })).toBeInTheDocument();
    expect(
